    ...
    private void getMakanan(){
        class GetMakanan extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam("https://lat1-dilan.000webhostapp.com/web_service/Makanan/get_makanan.php?no=",id);
                return s;
            }
        }
    ...
    private void updateMakanan(){
        ...
        class UpdateMakanan1 extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest("https://lat1-dilan.000webhostapp.com/web_service/Makanan/update_makanan.php", hashMap);
